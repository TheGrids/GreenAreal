                ...
                <nav>
                    <div className='nav_box'>
                        ...
                        <div className='nav_buttons'>
                            ...
                            <Link className='nav_some_button' to={import.meta.env.VITE_BASE_URL + '/cart'}>
                                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className='nav_some_button'>
                                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M15 2.5C8.09625 2.5 2.5 8.09625 2.5 15C2.5 21.9037 8.09625 27.5 15 27.5C21.9037 27.5 27.5 21.9037 27.5 15C27.5 8.09625 21.9037 2.5 15 2.5Z" stroke="black" strokeWidth="1.875" strokeLinecap="round" strokeLinejoin="round"/>
                                    <path d="M5.33875 22.9325C5.33875 22.9325 8.125 19.375 15 19.375C21.875 19.375 24.6625 22.9325 24.6625 22.9325M15 15C15.9946 15 16.9484 14.6049 17.6516 13.9017C18.3549 13.1984 18.75 12.2446 18.75 11.25C18.75 10.2554 18.3549 9.30161 17.6516 8.59835C16.9484 7.89509 15.9946 7.5 15 7.5C14.0054 7.5 13.0516 7.89509 12.3483 8.59835C11.6451 9.30161 11.25 10.2554 11.25 11.25C11.25 12.2446 11.6451 13.1984 12.3483 13.9017C13.0516 14.6049 14.0054 15 15 15Z" stroke="black" strokeWidth="1.875" strokeLinecap="round" strokeLinejoin="round"/>
                                </svg>
                            </div>
                        </div>
                    </div>
