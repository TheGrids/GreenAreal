...
const SearchBox: FC = () => {
    ...
    return (
        <div>
            <form style={{borderRadius}} onFocus={() => setIsFocused(true)} className='search_box' onSubmit={searchProducts}>
                <input  type="search" placeholder='Поиск по сайту' value={value} onChange={(e) => setValue(e.target.value)}/>
